...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
			.antMatchers("/", "/index.jsp","/club/categoryList.do","/club/clubList.do","/admin/mainBannerList.do","/club/clubSearch.do","/member/memberCreate.do","member/sendCode.do","/member/checkNicknameDuplicate.do", "/member/memebrInsertEmail.do","/member/checkIdDuplicate.do").permitAll() //요청은 모든 사용자에게 허용
