...
<body>
	<form:form name="memberCreateFrm" action="" method="POST" modelAttribute="member">
	   ...
	   <div id="step1"> <!-- 아이디,이름,닉네임 받으 -->
		...
		<div id="changeStep"> <!-- 이전 다음 버튼 -->
	<!-- 		<div id="changePrevious">
				<button type="button" onclick="previousStep()" id="previousButton"
